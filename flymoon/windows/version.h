...
#define PRODUCT_NAME           "flymoon" // 产品名称
...
#define INTERNAL_NAME          "flymoon.exe"
#define FILE_DESCRIPTION       "It's a chat bot for OpenAI compatible API "  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "flymoon.exe"    // 原始文件名
